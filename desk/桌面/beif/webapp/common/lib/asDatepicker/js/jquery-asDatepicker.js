    ...
    Plugin.prototype = {
        ...
        _position: function() {
            ...
            var calendar_height = this.$picker.outerHeight(),
                ...
                left,
                top,
                align = this.options.horizontalAlign,
            ...
            if (this.isMobile) {
                ...
                switch (position) {
                    case 'top':
                        ...
                        if(align === 'right'){
                            //代码重复1
                            if( calendar_width > input_width){
                                left = input_left - (calendar_width - input_width);
                            }
                            else{
                                left = input_left + (input_width - calendar_width);
                            }
                            //代码重复1 end
        ...
        hide: function() {
            if (this.showed === true) {
                ...
                if(this.options.hideFn && typeof this.options.hideFn === 'function'){
                    this.options.hideFn(this);
                }
