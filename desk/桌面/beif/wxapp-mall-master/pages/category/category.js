...
Page({
    ...
    filterFn: function (e) {
        ...
        switch (f_type) {
            case 'dynamic': parm = this.selectAlloptFn(e);
                ...
                oldForm.orderWidth = parm.sizeSelStr;
                ...
                let tempArr = [
                        {
                            ...
                            values: [{place:'北京',code:'21'},{place:'上海',code:'22'}]
                        }
                    ],
                    tempArr2 = [
                        {
    ...
    resetFilterOptFn : function(){
        ...
        filtersizeData[0].sel_ind = [].concat(this.data.filterSizeOpt_bef);
    ...
    selectAlloptFn: function (e) {
        ...
        if (sizeOptData[0].hasSel){
            ...
            if (sizeSelStr !== ''){
                sizeSelStr = sizeSelStr.slice(0,-1);
                arr.push('尺寸:'+sizeSelStr);

                filterSizeTil = sizeSelStr;
            ...
            if (this.data.swichinpt_text === '精准筛选'){
                ...
                if( checkV.width ){
                    filterSizeTil = checkV.width;
                }
                
                if (checkV.depth){

                    if (checkV.width) {
                        filterSizeTil += '-' + checkV.depth;
                    }
                    else{
                        filterSizeTil = checkV.depth;
                    }
                ...
                if (checkV.height) {
                    ...
                    if (checkV.width || checkV.depth){
                        filterSizeTil += '-' + checkV.height;
                    }
                    else{
                        filterSizeTil = checkV.height;
                    }
                ...
                if (checkV.width_l) {
                    filterSizeTil = checkV.width_l;
                }

                if (checkV.width_u) {

                    if (checkV.width_l) {
                        filterSizeTil += '-' + checkV.width_u;
                    }
                    else {
                        filterSizeTil = checkV.width_u;
                    }
                ...
                if (checkV.depth_l) {
                    ...
                    if (checkV.width_l || checkV.width_u) {
                        filterSizeTil += '、' + checkV.depth_l;
                    }
                    else {
                        filterSizeTil = checkV.depth_l;
                    }
                ...
                if (checkV.depth_u) {
                    ...
                    if (checkV.width_l || checkV.width_u || checkV.depth_l) {
                        filterSizeTil += '-' + checkV.depth_u;
                    }
                    else {
                        filterSizeTil = checkV.depth_u;
                    }
                ...
                if (checkV.height_l) {
                    ...
                    if (checkV.width_l || checkV.width_u || checkV.depth_l || checkV.depth_u) {
                        filterSizeTil += '、' + checkV.height_l;
                    }
                    else {
                        filterSizeTil = checkV.height_l;
                    }
                ...
                if (checkV.height_u) {
                    ...
                    if (checkV.width_l || checkV.width_u || checkV.depth_l || checkV.depth_u || checkV.height_l) {
                        filterSizeTil += '-' + checkV.height_u;
                    }
                    else {
                        filterSizeTil = checkV.height_u;
                    }
        ...
        sizeOptData[0].selectName = filterSizeTil;
        ...
        let filterMoreTil = arr.length ? "多选" : "更多";
        let filterPriceTil = '价格';

        if (checkV.minPriceV){
            filterPriceTil = checkV.minPriceV;
        }

        if (checkV.maxPriceV){

            if (checkV.minPriceV){
                filterPriceTil += '-' + checkV.maxPriceV;
            }
            else{
                filterPriceTil = checkV.maxPriceV;
            }
        ...
        if (this.data.swichinpt_text === '精准筛选') {
            this.setData({
                ...
                filterMoreTil: filterMoreTil,
                filterPriceTil: filterPriceTil,
                filterSizeTil : filterSizeTil
            });
    ...
    filterTest2: function () {
        ...
        selName = selName == '' ? '产地' : selName.slice(0,-1);
