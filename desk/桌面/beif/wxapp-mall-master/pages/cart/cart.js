  ...
  placeOrder:function(e){
    ...
    rq({
      ...
      success: function (r) {
        ...
        //发送服务通知
          let orderNum = r.data.data;
          let time = commJS.getFormatTime('show');
          console.log('formId:' + fromId);
          rq({
              url: baseURL + 'accessToken',
              success: function (r) {

                  commJS.sentServerNotice({
                      rq: rq,
                      template_id: '-8ZhE-syWDbABJfV6sAYX32wMoHBZh3MDQahxlu-8Uk',
                      formId: fromId,
                      accessToken: r.data.data,
                      pageInd: 'pages/orders/orders',
                      emphasis_keyword: "",
                      data: {
                          "keyword1": {
                              "value": '成功',
